...
- **برنامج روحي هيكلي** لمدة شهر كامل — كل يوم له عنوان وآية وقائمة مهام مخصصة
- **بطاقة تهنئة احتفالية** عند اكتمال اليوم: تنبثق في أعلى الصفحة مع اسم اليوم بخط ذهبي + 5 نجوم + ترفاي متحرك + آية كريمة، وتختفي تلقائياً بعد 7 ثوانٍ
- **التمرير التلقائي لأعلى** فور الضغط على "انطلق لليوم التالي" لتظهر بطاقة التهنئة مباشرة
- **عداد ذكر مدمج** داخل المهام — يُعدّ الاستغفار والتسبيح مباشرة من صفحة الرحلة
- **قارئ قرآن مدمج** — يفتح السورة المطلوبة مباشرة من مهمة اليوم مع تلاوة صوتية
- **زر ورد القرآن** — لتسجيل إتمام صفحات القرآن المطلوبة ضمن المهمة
- **تكامل الذنوب المختارة** — خطة شخصية مبنية على ما اختاره المستخدم من ذنوب ومعاصٍ
- عداد الأيام المتتالية (Streak) ومجموع الأيام المكتملة
- استعادة التقدم بكود سري في أي وقت
...
صفحة رئيسية متكاملة تحتوي على 11 قسماً فرعياً:

| القسم | الوصف |
|-------|-------|
| **قراءة** | 114 سورة بتشكيل كامل وتمييز الآية الحالية |
| **استماع** | تلاوة صوتية لكل آية مع دعم قراء متعددين |
| **تفسير** | تفسير الآيات وربطها بالواقع |
| **التجويد** | شرح تفاعلي لأحكام التجويد |
| **الحفظ** | نظام مساعدة على حفظ الآيات مع التكرار |
| **البطاقات** | بطاقات مراجعة للآيات المحفوظة |
| **التحديات** | تحديات قرآنية يومية ومجتمعية |
| **الختمات** | تتبع ختمات القرآن مع تسجيل التقدم بالصفحات |
| **الإعجاز** | معجزات القرآن — عددية، علمية، لغوية، تاريخية |
| **خريطة القرآن** | نظرة بصرية شاملة لبنية القرآن |
| **مساعد AI** | أسئلة وأجوبة قرآنية بالذكاء الاصطناعي |

**ميزات تقنية في القارئ:**
- تشغيل تلقائي ومتسلسل للآيات
- تحميل مسبق للآية التالية لأداء سلس
- بحث سريع في الأسماء العربية والإنجليزية
- عرض معلومات السورة: عدد الآيات، الجزء، المعنى، المكية/المدنية
- **تتبع ورد القرآن اليومي** بالصفحات من الصفحة الرئيسية

---

### 🌙 وضع المناجاة `/munajat`

وضع تأملي روحي شامل مع خمسة مشاهد طبيعية متحركة وستة عشر صوتاً إجرائياً:

**المشاهد الطبيعية (تتبدل كل 30 ثانية أو يدوياً):**
- 🌌 **سماء الليل** — نجوم + شهب متساقطة، الاختيار التلقائي من 8م حتى 4ص
- 🌿 **غابة الفجر** — يراعات متلألئة في العتمة، الاختيار التلقائي من 4ص حتى 11ص
- 🌊 **شاطئ هادئ** — نجوم تنعكس على الماء، الاختيار التلقائي من 11ص حتى 5م
- 🏜️ **صحراء الليل** — حبيبات رمال في الريح، الاختيار التلقائي من 5م حتى 8م
- ⛰️ **جبال المطر** — قطرات مطر متساقطة ببطء

**مجموعات الصوت (16 صوتاً إجرائياً بدون ملفات):**
- *طبيعة*: صامت · مطر · نسيم · نهر · أمواج
- *طيور*: طيور · بلبل · ليل ساكن (صراصير)
- *غابة*: الكروان المصري · غابة الفجر · شاطئ بنوارس · صنوبر
- *أرض*: رعد ومطر · نهر جبلي · صحراء ليلية · غابة استوائية

**أذكار:** عداد تفاعلي لـ 4 أذكار مع مؤثرات بصرية وإشارات الإنجاز (33 / 66 / 99)

**آيات المناجاة:** آيات قرآنية تتدوار كل 8 ثوانٍ
