...
function SectionJourneyCard() {
  ...
  return (
    <div className="rainbow-border shadow-xl shadow-black/8 mb-[23px] mt-[-28px]">
      <div className="rainbow-border-inner p-5 text-left pl-[40px] pr-[40px] pt-[13px] pb-[13px]">
      {!hasCovenant ? (
...
export default function Home() {
  ...
  return (
    <div className="flex flex-col flex-1 pb-8">
      ...
      <div className="px-5 relative z-10 flex flex-col gap-4 mt-[-115px] pl-[45px] pr-[45px]">
