...
function SectionJourneyCard() {
  ...
  return (
    <div className="rainbow-border shadow-xl shadow-black/8 mb-3">
      <div className="rainbow-border-inner p-5">
      {!hasCovenant ? (
        <div className="text-center flex flex-col items-center">
          ...
          <Link href="/covenant" className="w-full py-3.5 rounded-xl font-bold text-base hover:opacity-90 active:scale-[0.98] transition-all shadow-md flex items-center justify-center gap-2 bg-[#243f6638] text-[#1e649c]">
