  ...
  return (
    ...
    >
      ...
      <div className="flex-1 min-w-0">
        ...
        <p
          className="font-semibold leading-relaxed mb-1.5 dark:text-white/90 text-[#2acf1be6] text-center"
          style={{ fontSize: 13 }}
        >
          «{hadith.text}»
        </p>
        <p className="text-amber-700/70 dark:text-amber-400/60" style={{ fontSize: 11 }}>{hadith.narrator}</p>
      </div>
    </div>
  );
}
